...
import sys
import mock
from tango_simlib import __version__
...
# that include C code
MOCK_MODULES = ['PyTango', 'PyTango.server', 'PyTango._PyTango', 'jsonschema']
...
man_pages = [
    (master_doc, 'tango-simlib', u'tango-simlib Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'tango-simlib', u'tango-simlib Documentation',
     author, 'tango-simlib', 'One line description of project.',
     'Miscellaneous'),
]

# -*- coding: utf-8 -*-
#
# tango-simlib documentation build configuration file, created by
...
# that include C code
MOCK_MODULES = ["PyTango", "PyTango.server", "PyTango._PyTango",
                "jsonschema", "tango", "tango.server", "numpy", "pathlib", "yaml"]
...
htmlhelp_basename = "tango-simlib-doc"
...
man_pages = [(master_doc, "tango-simlib", u"tango-simlib Documentation", [author], 1)]
